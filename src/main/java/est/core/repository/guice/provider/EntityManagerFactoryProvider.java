package est.core.repository.guice.provider;
...
import est.core.repository.utils.ConfigurationProperties;
...
public class EntityManagerFactoryProvider implements Provider<EntityManagerFactory> {
    ...
    protected Map<String, String> getDatabaseProperties() {
        ...
        properties.put("hibernate.connection.username", configuration.getString(
                ConfigurationProperties.DATABASE_USERNAME));
        properties.put("hibernate.connection.password", configuration.getString(
                ConfigurationProperties.DATABASE_PASSWORD));
